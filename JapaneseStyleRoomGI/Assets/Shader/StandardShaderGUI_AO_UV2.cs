...
{
internal class StandardShaderGUI_AO_UV2 : ShaderGUI
{
	...
	private static class Styles
	{
		...
		public static GUIContent aoMapTitle = new GUIContent("AO Map (UV1)", "AO Map (UV1)");
		public static GUIContent aoMapText = new GUIContent("AO Map", "AO Map");
	...
	MaterialProperty aoMapIntensity = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
		...
		aoMapIntensity = FindProperty ("_AOMapIntensity", props);
	}
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			GUILayout.Label(Styles.aoMapTitle, EditorStyles.boldLabel);
			if (aoMap.textureValue == null)
				m_MaterialEditor.TexturePropertySingleLine(Styles.aoMapText, aoMap);
			else
				m_MaterialEditor.TexturePropertySingleLine(Styles.aoMapText, aoMap, aoMapIntensity);
		}
		if (EditorGUI.EndChangeCheck())
		{
